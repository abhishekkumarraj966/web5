              ...
              <AppLayout>
                <div className="mb-4 bg-[#151D09] w-[95%] mx-auto h-auto my-15 rounded-2xl sm:mx-5 sm:px-5">
                  <div className="py-2 ">
                    <label
                      htmlFor="name"
                      className="block  font-semibold text-[#36C478]  mx-10  lg:text-2xl text-lg"
                    >
                      Name:
                    ...
                    <div className=" p-4 rounded-md">
                      <div className="sm:ml-10">
                        <button
                          ...
                          className="bg-[#38CB89] text-white px-4 py-2 rounded-md hover:bg-[#38CB89] focus:outline-none focus:shadow-outline-blue w-28 h-10"
